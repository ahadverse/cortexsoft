...
const tiers = [
  {
    ...
    highlight: false,
    features: [
      { label: "Up to 1,000 emails / month", included: true },
      { label: "5 autoresponder sequences", included: true },
      { label: "Basic email templates", included: true },
      { label: "Open rate tracking", included: true },
      { label: "Email support", included: true },
      { label: "Unlimited autoresponders", included: false },
      { label: "A/B split testing", included: false },
      { label: "Click & conversion tracking", included: false },
      { label: "Drip campaign builder", included: false },
      { label: "Custom SMTP / dedicated IP", included: false },
  ...
  },
  {
    ...
    highlight: true,
    features: [
      { label: "Up to 25,000 emails / month", included: true },
      { label: "Unlimited autoresponder sequences", included: true },
      { label: "Custom branded templates", included: true },
      { label: "Open & click tracking", included: true },
      { label: "Priority support", included: true },
      { label: "A/B split testing", included: true },
      { label: "Click & conversion tracking", included: true },
      { label: "Drip campaign builder", included: true },
      { label: "Custom SMTP / dedicated IP", included: false },
      { label: "API access", included: false },
  ...
  },
  {
    ...
    highlight: false,
    features: [
      { label: "Unlimited emails / month", included: true },
      { label: "Unlimited autoresponder sequences", included: true },
      { label: "Custom branded templates", included: true },
      ...
      { label: "Click & conversion tracking", included: true },
      { label: "Drip campaign builder", included: true },
      { label: "Custom SMTP & dedicated IP", included: true },
...
const EmailResponder = () => {
  return (
    <div>
      <Head>
        <title>Email Responder | CortexSof</title>
        <meta name="description" content="Automate your email communication with CortexSof Email Responder — intelligent autoresponders that keep your customers engaged around the clock." />
      </Head>
      <Layout>
        <div className="bg-blue-100 pb-16">
          <div className="text-center pt-10 pb-4">
            ...
            <h1 className="text-5xl font-bold mt-1">
              <span className="animatetext">Email Responder</span>
            </h1>
            <p className="mt-4 text-gray-600 max-w-2xl mx-auto px-4">
              Automate your email replies with a smart autoresponder triggered by user
              actions on your site or incoming emails. Ensure timely, personalized
              communication at every stage of the customer journey — without lifting a finger.
            </p>
          </div>
